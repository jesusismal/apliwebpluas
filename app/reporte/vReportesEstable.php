                        ...
                        <div class="panel panel-default panel-table panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <br>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <!-- <span class='label label-danger' >Escoger</span> <br>  -->
                                            <b>Fecha de Inicio</b>
                                        ...
                                        <div class="col-lg-2">
                                            <br>
                                            <label class="form-control"><input type="radio" id="chkVenta" name="rdn" checked>Venta</label>                                            
                                        </div>
                                        <div class="col-lg-2">
                                            <br>
                                            <label class=" form-control"><input type="radio" id="chkCompra" name="rdn" >Bodega</label>                                           
                                        </div>
                                        <div class="col-xs-2">
                                            <br>
                                    ...
                                    <div class="row" id="panel_ventas" style="display:none;">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row" id="panel_compras" style="display:none;">
                                        <div class="col-md-6">
            ...
            $(function () {
                ...
                $('#btn_limpiarReportes').on('click',function(){
                    $('#id_comboReporte').html('');
                     ...
                     $('#panel_ventas').css('display','none');
                     $('#panel_compras').css('display','none');
                });
                $('#btn_listarComboReportes').on('click', function () {

                    // console.log($('#chkVenta').prop('checked'))
                    if($('#chkVenta').prop('checked'))
                    {
                        $('#panel_ventas').css('display','block');
                        $('#panel_compras').css('display','none');
                    }else
                    {
                        $('#panel_ventas').css('display','none');
                        $('#panel_compras').css('display','block');
                    }
                    $.ajax({
