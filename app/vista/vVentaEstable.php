                            ...
                            <div class="panel-body">
                                <form id="formulario" class="form-horizontal" action="" method="POST">
                                    <div class="row-fluid text-right">
                                        ...
                                        <div class="col-lg-3">
                                            <label class="control-label col-xs-7">Num. Venta</label>   
                                            <div class="col-xs-5">
                                        ...
                                        <div class="panel panel-warning">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-2">
                                                        <b>Fecha</b> 
                                                        <input required="required" id="fechaaux" type="text" class="form-control" value="<?= date('Y-m-d H:i:s') ?>" disabled style="padding: 8px;">
                                                    ...
                                                    <div class="col-xs-2">
                                                    <br>                              
                                                        <label>Contado <input type="checkbox" id="contado" checked ></label>
                                                    </div>
                                                    <div class="col-xs-12">
                                                        <br>
                                                    </div>
                                                    <div class="col-xs-8 text-right">
                                                        <b>La venta se Encuentra</b>  
                                                    </div>
                                                        <div class="col-xs-4">
                                                            <div class="row">                    
                                                                <div class="col-xs-6">
                                                                    <label><input name="entregado" value="m" id="entregados" type="radio" checked>Entregada?</label>
                                                                </div>
                                                                <div class="col-xs-6">
                                                                    <label><input name="entregado" value="f" id="entregadon" type="radio" class=""notchecked>No Entregada?</label>             
                                                                </div>
                                                            </div>                                                    
                                                        </div> 
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-1">
                                            <b>Precio</b>                                               
                                            <input id="id_precio" readonly class="form-control" placeholder="Precio" value="0" />  
                                        </div>
                                         <div class="col-xs-1">
                                            <b>Total</b>                                               
                                            <input id="id_total" readonly class="form-control" placeholder="Total" value="0" />  
                                        </div>
                                        <div class="col-xs-2">
                                            <br>
