                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="" class="active">Ingreso de inventario</a> <span class="divider">/</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-12">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-danger">
                                            <div class="panel-heading">
                                                <h4>Datos de la orden de produccion</h4>
                                            </div>
                                            <div class="panel-body">
                                                <div class="col-lg-4">
                                                    <b>Operador</b>   
                                                ...
                                                <div class="col-lg-2">
                                                    <b>Fecha</b> 
                                                    <input required="required" id="fechaaux" type="text" class="form-control" value="<?= date('Y-m-d H:i:s') ?>" disabled style="padding: 3px;">
                                                ...
                                                <div class="col-lg-2">
                                                    <!-- <label class="col-xs-4">Contado</label> -->
                                                    <!-- <div class="col-xs-8 text-center"> -->
                                                        <br>
                                                        <label class="form-control">Contado  <input type="checkbox" id="contado" checked ></label>
                                                    <!-- </div> -->
                                                </div>
                                                 <div class="col-lg-2">
                                                <br>
                                                    <label class="col-xs-7">Iva %?</label>
                                                ...
                                                <div class="col-lg-4">
                                                    <label class="col-xs-9">Desc Prov Habitual %?</label>
                                                    <div class="col-xs-3" style="padding:0px">
                                                        <input class="form-control" type="number" id="clienteAvitual" min="0" max="99" maxlength="99" value="0">
                                                    </div>
                                                </div>
                        ...
                        <div class="row-fluid">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h4><strong>Detalle de la orden</strong></h4>  
                                </div>  
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-1">
                                            <b>Cant (Unt)</b>
                                            <input id="id_cantidad" class="form-control" type="text" placeholder="Cant" onblur="calcula_total()" />
                                        </div>                                        
                                        <div class="col-xs-1 ">
                                            <b>Costo</b>                                            
                                            <input id="id_precio" readonly class="form-control" type="number" placeholder="Precio" value="0" />                                           
                                        </div>
                                         <div class="col-xs-1">
                                            <b>Total</b>
                                            <input id="id_total" class="form-control" type="text" placeholder="Total" value="0" readonly />
                                        </div>                                        
                                        <div class="col-xs-2">
                                            <br>
...
$('#iva').on('change',function(){
                ...
                $('#btn_grabarFactura').on('click', function () {
                    if (app.factura.items.length === 0) {
                        ...
                        if (window.confirm("Esta Seguro de ingresar esta producto a bodega")) {
